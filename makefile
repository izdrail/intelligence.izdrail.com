...
# 🧪 Test the model
test:
	curl -s http://localhost:$(PORT)/api/generate -d "{\"model\": \"gemma3:12b\", \"prompt\": \"Rewrite the following text: The house is green and the boy listen to the music. \", \"stream\": false}" | jq .
